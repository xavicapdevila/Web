...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/propiedades`, lastModified: new Date(), priority: 0.9 },
    { url: `${BASE_URL}/quienes-somos`, lastModified: new Date(), priority: 0.7 },
    { url: `${BASE_URL}/valoracion`, lastModified: new Date(), priority: 0.8 },
    { url: `${BASE_URL}/blog`, lastModified: new Date(), priority: 0.7 },
    { url: `${BASE_URL}/contacto`, lastModified: new Date(), priority: 0.7 },
  ];
