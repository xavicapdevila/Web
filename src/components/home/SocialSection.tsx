  ...
  return (
    <section className="py-20 bg-[#050505] border-t border-[#1a1a1a]">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <h2 className="font-display text-3xl lg:text-4xl text-white font-light leading-[1.05] mb-14">
          {t("socialFollow")}
        </h2>
        ...
        <div className="flex items-center justify-center gap-10 md:gap-20">
          ...
          <a
            ...
            className="flex flex-col items-center gap-3 text-[#8a8a8a] hover:text-[#C9B99A] transition-colors"
          >
