          ...
          <div className="bg-[#111] border border-[#1e1e1e] p-6">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-3 w-full px-4 py-3 border border-[#25D366]/40 text-[#25D366] font-body text-sm tracking-wide hover:bg-[#25D366]/10 transition-colors"
              >
